                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6  ">
                                    <div class="form-floating">
                                        <input type="text" name="txtCod"  readonly="readonly" class="form-control" id="floatingInput" value="<%=em.getCod()%>" >
                                        <label for="floatingInput">Codigo</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="txtNom" class="form-control"  value="<%=em.getNom()%>" id="floatingInput" >
                                        <label for="floatingInput">Nombres</label>
                                    </div>
                                    <div class="form-floating mt-2">
                                        <input type="text" name="txtNomUsu" class="form-control" value="<%=em.getNomusu()%>"id="floatingInput" >
                                        <label for="floatingInput">Nombre de usuario</label>

                                    </div>
                                    <div class="form-floating mt-2">
                                        <input type="tel" name="txtDni" class="form-control" value="<%=em.getDni()%>" id="floatingInput" >
                                        <label for="floatingInput">DNI</label>

                                    </div>
                                    <div class="form-floating mt-2">
                                        <input type="password" name="txtPass" value="<%=em.getContraseña()%>" class="form-control" id="floatingPassword" >
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-floating ">
                                        <input type="text" name="txtApellido" class="form-control" value="<%=em.getApell()%>" id="floatingInput" >
                                        <label for="floatingInput">Apellidos</label>

                                    </div>
                                    <div class="form-floating mb-2 mt-2">
                                        <input type="email" name="txtCorreo" value="<%=em.getCorreo()%>" class="form-control" id="floatingInput">
                                        <label for="floatingInput">Correo Electrónico</label>
                                    </div>
                                    <div class="form-floating mb-2 mt-2">
                                        <input type="tel" name="txtTel" value="<%=em.getTelefono()%>" class="form-control" id="floatingInput">
                                        <label for="floatingInput">Teléfono</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="txtTipo" value="<%=em.getTipo()%>" class="form-control" id="floatingInput">
